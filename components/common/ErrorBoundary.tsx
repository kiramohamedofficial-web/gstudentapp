...
class ErrorBoundary extends Component<Props, State> {
  // FIX: Using a constructor to initialize state ensures `this.props` is correctly passed to the superclass constructor, resolving potential TypeScript errors.
